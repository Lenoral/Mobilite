...
def requete_destinations_api(nom_recherche):
    ...
    if gares_recherche.empty:
        ...
        def add_dist_df(x):
            ...
            return(round(cdist.get_dist_km(lon_ori,lat_ori,x['lon'],x['lat']),1))
...
def affichage_destination_map(nom_recherche):
    ...
    for i in range(n):
        ...
        new_coord= cdist.coord_homotethie(departs_gares_longitude,departs_gares_latitude,longitude,latitude,0.5)
